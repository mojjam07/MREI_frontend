...
const translations = {
  en: {
    ...
    home: {
      ...
      addressValue: "12A Baale Street Ishagatedo Mushin Road, Lagos 12345",
  ...
  ar: {
    ...
    home: {
      ...
      campusLifeHover: 'الحياة الجامعية',
      ...
      message: "الرسالة",
      send: "إرسال",
      addressValue: "شارع 9A بالي إشاغاتيدو طريق موشن، لاغوس 12345",
      phoneValue: "+1 (555) 123-4567",
      emailValue: "info@mahdurahmah.edu",
