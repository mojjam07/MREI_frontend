...
const translations = {
  en: {
    ...
    admin: {
      ...
      dashboardSection: {
        ...
        campusLifeManagement: 'School Life Management',
        campusLifeDescription: 'Manage school life content and activities',
    ...
    about: {
      ...
      deanTitle: "Registrar of the Institution",
    ...
    academics: {
      ...
      subtitle: "Nurturing faith, knowledge, and character through authentic Islamic learning",

      collegesTitle: "Faculties & Institutes",
      collegesSubtitle: "Explore our structured Islamic learning institutions",

      theologyTitle: "Faculty of Islamic Theology",
      theologyDesc: "Deepening understanding of Islamic beliefs and creed",
      aqeedahProgram: "Aqeedah (Islamic Creed)",
      tafsirProgram: "Tafsir (Qur’anic Exegesis)",
      hadithProgram: "Hadith Studies",

      shariaTitle: "Faculty of Shariah & Law",
      shariaDesc: "Teaching Islamic law and its application in contemporary life",
      fiqhProgram: "Fiqh (Islamic Jurisprudence)",
      usulFiqhProgram: "Usul al-Fiqh",
      islamicLawProgram: "Islamic Legal Theory",

      quranTitle: "Faculty of Qur’an & Memorization",
      quranDesc: "Preserving and mastering the Book of Allah",
      hifzProgram: "Hifz al-Qur’an",
      tajweedProgram: "Tajweed & Qira’at",
      quranStudiesProgram: "Qur’anic Studies",

      educationTitle: "Faculty of Islamic Education",
      educationDesc: "Preparing educators grounded in Islamic values",
      islamicEducationProgram: "Islamic Education",
      arabicEducationProgram: "Arabic Language Education",
      dawahProgram: "Da‘wah & Community Development",

      // Faculty of Arabic Language & Linguistics
      arabicLanguageTitle: "Faculty of Arabic Language & Linguistics",
      arabicLanguageDesc: "Developing mastery of Arabic for understanding Islamic texts",
      ...
      dawahDesc: "Training scholars and leaders in Islamic outreach and communication",
      islamicMediaProgram: "Islamic Media & Communication",
      khutbahProgram: "Khutbah & Public Speaking",
      interfaithProgram: "Interfaith Dialogue",

      // Faculty of Islamic History & Civilization
      islamicHistoryTitle: "Faculty of Islamic History & Civilization",
      islamicHistoryDesc: "Studying Islamic heritage and civilization through the ages",
      seerahProgram: "Seerah of the Prophet ﷺ",
      islamicCivilizationProgram: "Islamic Civilization",
      islamicHeritageProgram: "Islamic Heritage Studies",


      undergraduateTitle: "I\n'hdaadiyyah Programs",
      undergraduateDesc: "Four-Years Foundational programs for comprehensive Islamic education",
      bachelorDegrees: "Thaanawiyyah Programs",
      bachelorDesc: "Three-year programs combining classical and contemporary Islamic studies",
      "120CreditHour": "120 credit hours typically required",
      generalEducation: "Islamic studies foundation courses",
      majorRequirements: "Specialized field requirements",
      electiveCourses: "Electives in Arabic, Da‘wah, and ethics",

      graduateTitle: "Graduate Programs",
      graduateDesc: "Advanced Islamic scholarship and research",
      masterDegrees: "Master's Degrees",
      masterDesc: "Advanced study in Islamic sciences",
      doctoralDegrees: "Doctoral Degrees",
      doctoralDesc: "Research-based programs in Islamic thought and law",

      certificatePrograms: "Certificate Programs",
      certificateDesc: "Short-term programs for Imams, teachers, and Da‘wah workers",
      ...
      libraryDesc: "Access to classical and contemporary Islamic texts",
      onlineLearningTitle: "Online Islamic Learning",
      onlineLearningDesc: "Flexible access to Islamic courses worldwide",
      researchTitle: "Research & Fatwa Centers",
      researchDesc: "Centers dedicated to Islamic research and guidance",
  ...
  ar: {
    ...
    academics: {
      ...
      subtitle: "تنمية الإيمان والعلم والأخلاق من خلال تعليم إسلامي أصيل",

      collegesTitle: "الكليات والمعاهد",
      collegesSubtitle: "اكتشف مؤسساتنا التعليمية الإسلامية المنظمة",

      theologyTitle: "كلية العقيدة والدراسات الإسلامية",
      theologyDesc: "تعميق فهم العقيدة الإسلامية وأصول الإيمان",
      aqeedahProgram: "العقيدة الإسلامية",
      tafsirProgram: "التفسير",
      hadithProgram: "علوم الحديث",

      shariaTitle: "كلية الشريعة والفقه",
      shariaDesc: "تعليم الشريعة الإسلامية وتطبيقها في الواقع المعاصر",
      fiqhProgram: "الفقه الإسلامي",
      usulFiqhProgram: "أصول الفقه",
      islamicLawProgram: "النظرية القانونية الإسلامية",

      quranTitle: "كلية القرآن الكريم وتحفيظه",
      quranDesc: "حفظ كتاب الله وإتقان تلاوته",
      hifzProgram: "حفظ القرآن الكريم",
      tajweedProgram: "التجويد والقراءات",
      quranStudiesProgram: "علوم القرآن",

      educationTitle: "كلية التربية الإسلامية",
      educationDesc: "إعداد معلمين قائمين على القيم الإسلامية",
      islamicEducationProgram: "التربية الإسلامية",
      arabicEducationProgram: "تعليم اللغة العربية",
      dawahProgram: "الدعوة وتنمية المجتمع",

      // كلية اللغة العربية وعلومها
      arabicLanguageTitle: "كلية اللغة العربية وعلومها",
      arabicLanguageDesc: "تنمية إتقان اللغة العربية لفهم النصوص الإسلامية",
      nahwProgram: "النحو",
      sarfProgram: "الصرف",
      balaghaProgram: "البلاغة",

      // كلية الدعوة والإعلام الإسلامي
      dawahTitle: "كلية الدعوة والإعلام الإسلامي",
      dawahDesc: "إعداد العلماء والقادة في مجال الدعوة والتواصل الإسلامي",
      islamicMediaProgram: "الإعلام الإسلامي",
      khutbahProgram: "الخطابة وفنون الإلقاء",
      interfaithProgram: "الحوار بين الأديان",

      // كلية التاريخ والحضارة الإسلامية
      islamicHistoryTitle: "كلية التاريخ والحضارة الإسلامية",
      islamicHistoryDesc: "دراسة التراث والحضارة الإسلامية عبر العصور",
      seerahProgram: "السيرة النبوية ﷺ",
      ...
      bachelorDesc: "برامج دراسية مدتها ثلاث سنوات تجمع بين الأصالة والمعاصرة",
      "120CreditHour": "120 ساعة معتمدة مطلوبة عادة",
      generalEducation: "مقررات تأسيسية في العلوم الإسلامية",
      majorRequirements: "متطلبات التخصص",
      electiveCourses: "مقررات اختيارية في العربية والدعوة والأخلاق",

      graduateTitle: "برامج الدراسات العليا",
      graduateDesc: "التعمق في البحث والدراسات الإسلامية المتقدمة",
      masterDegrees: "درجة الماجستير",
      masterDesc: "دراسة متقدمة في العلوم الإسلامية",
      doctoralDegrees: "درجة الدكتوراه",
      doctoralDesc: "برامج بحثية في الفكر الإسلامي والشريعة",

      certificatePrograms: "برامج الشهادات",
      certificateDesc: "برامج قصيرة للأئمة والمعلمين والدعاة",
      ...
      libraryDesc: "الوصول إلى الكتب والمراجع الإسلامية التراثية والمعاصرة",
      onlineLearningTitle: "التعلم الإسلامي الإلكتروني",
      onlineLearningDesc: "دورات إسلامية مرنة متاحة عالميًا",
      researchTitle: "مراكز البحث والإفتاء",
      researchDesc: "مراكز متخصصة في البحث الشرعي والإرشاد",
      calendarTitle: "التقويم الأكاديمي",
      calendarDesc: "المواعيد والمناسبات الأكاديمية الإسلامية"
    },
