...
const AboutUs = () => {
  ...
  const { ref: missionRef, animationClasses: missionAnimation } = useScrollAnimation();
  const { ref: historyRef, animationClasses: historyAnimation } = useScrollAnimation();
  const { ref: leadershipRef, animationClasses: leadershipAnimation } = useScrollAnimation();
  const { ref: valuesRef, animationClasses: valuesAnimation } = useScrollAnimation();
  const { ref: statsRef, animationClasses: statsAnimation } = useScrollAnimation();
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mt-6 sm:mt-8 lg:mt-12">
              ...
              <div className={`text-center hover-scale transition-transform duration-300 ${visibleStats.has(1) ? 'animate-count-up' : ''}`}>
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-accent mb-1 sm:mb-2">
                  {counters.students > 0 ? (counters.students >= 1000 ? `${(counters.students / 1000).toFixed(0)}K+` : counters.students) : '0'}
                </div>
              ...
              <div className={`text-center hover-scale transition-transform duration-300 ${visibleStats.has(2) ? 'animate-count-up' : ''}`}>
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-accent mb-1 sm:mb-2">
                  {counters.faculty > 0 ? (counters.faculty >= 1000 ? `${(counters.faculty / 1000).toFixed(0)}K+` : counters.faculty) : '0'}
                </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg text-center hover-lift hover-glow">
              <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gray-300 rounded-full mx-auto mb-3 sm:mb-4 transition-transform duration-300 hover-scale"></div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary mb-1 sm:mb-2">
                {t('about.presidentName')}
              </h3>
              <p className="text-accent text-xs sm:text-sm lg:text-base mb-1 sm:mb-2">{t('about.presidentTitle')}</p>
              <p className="text-gray-600 text-xs sm:text-sm">{t('about.presidentBio')}</p>
            </div>
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg text-center hover-lift hover-glow">
              <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gray-300 rounded-full mx-auto mb-3 sm:mb-4 transition-transform duration-300 hover-scale"></div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary mb-1 sm:mb-2">
              ...
              <p className="text-accent text-xs sm:text-sm lg:text-base mb-1 sm:mb-2">{t('about.vpTitle')}</p>
              <p className="text-gray-600 text-xs sm:text-sm">{t('about.vpBio')}</p>
            </div>
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg text-center hover-lift hover-glow xs:col-span-2 lg:col-span-1">
              <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gray-300 rounded-full mx-auto mb-3 sm:mb-4 transition-transform duration-300 hover-scale"></div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary mb-1 sm:mb-2">
                {t('about.deanName')}
              </h3>
              <p className="text-accent text-xs sm:text-sm lg:text-base mb-1 sm:mb-2">{t('about.deanTitle')}</p>
              <p className="text-gray-600 text-xs sm:text-sm">{t('about.deanBio')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <div className="text-center p-3 sm:p-4 lg:p-6 hover-lift hover-scale animate-fade-in-up animate-stagger-1">
              <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-accent rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 hover:rotate-12">
                <span className="text-white text-lg sm:text-xl lg:text-2xl font-bold">E</span>
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary mb-1 sm:mb-2">
            ...
            <div className="text-center p-3 sm:p-4 lg:p-6 hover-lift hover-scale animate-fade-in-up animate-stagger-2">
              <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-accent rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 hover:rotate-12">
                <span className="text-white text-lg sm:text-xl lg:text-2xl font-bold">I</span>
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary mb-1 sm:mb-2">
            ...
            <div className="text-center p-3 sm:p-4 lg:p-6 hover-lift hover-scale animate-fade-in-up animate-stagger-3 xs:col-span-2 lg:col-span-1">
              <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-accent rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-transform duration-300 hover:rotate-12">
                <span className="text-white text-lg sm:text-xl lg:text-2xl font-bold">C</span>
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary mb-1 sm:mb-2">
