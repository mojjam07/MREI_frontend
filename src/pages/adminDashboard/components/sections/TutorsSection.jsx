    ...
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start gap-3 animate-fade-in-up">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm sm:text-base text-primary-text/80 hidden sm:block">
            {t('dashboard.tutorsDescription') || 'Manage tutor profiles and information'}
          </p>
        </div>
        <div className="flex items-center gap-2 text-xs sm:text-sm text-primary-text/60">
        ...
        {safeTutors.length > 0 ? safeTutors.map((tutor, index) => (
          ...
          >
            <div className="flex flex-col">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-lg sm:text-xl font-semibold text-primary-text truncate">
                      {safeString(tutor?.first_name, 'Unknown Tutor')}
                    </h3>
                  </div>
              ...
              {/* Details */}
              <div className="flex flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm text-primary-text/60 mb-3">
                {tutor?.email && (
          ...
          <div className="glass-card p-8 sm:p-12 text-center animate-fade-in-up">
            <User className="w-12 h-12 sm:w-16 sm:h-16 mx-auto text-primary-text/20 mb-4" />
