...
//   return (
//     <section className="bg-tertiary relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 min-h-[70vh] sm:min-h-[85vh] md:min-h-screen overflow-hidden">
//       <style>
//         {`
//           .slick-dots {
//             z-index: 20;
...
//               {slide.type === 'video' ? (
//                 <video
//                   className="w-full h-full hero-slider-slide object-cover"
//                   autoPlay
//                   muted
//                   loop
//                   playsInline
